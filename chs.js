...
var cnItems = {
    ...
    "Artisan Workshop food": "工匠作坊食物",
    "Artisan Workshop gold": "工匠作坊黄金",
    "Artisan Workshop stone": "工匠作坊石头",
    "Artisan Workshop tools": "工匠作坊工具",
    "Artisan Workshop wood": "工匠作坊木头",
    "As we continue digging in the quarry we may find more minerals": "随着我们继续在采石场挖掘，我们可能会发现更多的矿物",
    "Crop Rotation food": "轮作食物",
    "Farm food": "农场食物",
    "Fatti non foste a viver come bruti ma per seguir virtute e canoscenza": "Fatti non foste a viver come bruti ma per seguir virtute e canoscenza",
    "Knowledge Area": "知识区",
    ...
    "Spearman": "矛兵",
    "The cheap front line of any deployment. It has a good defense (Tank)": "任何部署的廉价前线。 它有很好的防御（坦克）",
    "Warrior": "战士",
